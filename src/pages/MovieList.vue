...
export default {
  ...
  methods: {
    async fetchMovieDetails(movieId) {
      ...
      try {
        const response = await fetch(`http://ec2-3-108-252-153.ap-south-1.compute.amazonaws.com/movies/${movieId}/`, {
          method: 'GET',
          headers: {
  ...
  try {
    ...
    async searchMovies() {
      const url = `http://ec2-3-108-252-153.ap-south-1.compute.amazonaws.com/movies?keyword=${this.searchQuery}&page=1`;
      await this.fetchDataFromAPI(url);
    },

    async fetchPage(page) {
      if (page < 1 || page > this.totalPages) return;
      const url = `http://ec2-3-108-252-153.ap-south-1.compute.amazonaws.com/movies?keyword=${this.searchQuery}&page=${page}`;
      await this.fetchDataFromAPI(url);
    },
    async resetSearch() {
    ...
    this.fetchDataFromAPI('http://ec2-3-108-252-153.ap-south-1.compute.amazonaws.com/movies?page=1');
  },
  },
